      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg max-w-2xl mx-auto">
            Guided by curiosity, grounded in progress.  
            Learning and execution go hand in hand — each certification and milestone
            marks a checkpoint in becoming better at what I love doing.
          </p>
        </motion.div>
